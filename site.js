...
;
// Generated by CoffeeScript 1.4.0
var clickHandler, hasLunch, infoWindow, map, memoized, tapHandler, tmpl;
...
hasLunch = function(data) {
  return $.grep(data.meals, function(meal) {
