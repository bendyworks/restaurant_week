'use strict';
;
/* Zepto v1.0rc1-144-gdee1826 - polyfill zepto event fx selector - zeptojs.com/license */
;(function(undefined){
...
(function($) {
  ...
  return $.extend($.fn, {
    infoWindow: function(opts) {
      ...
      return $$.find('.tab-content:first').addClass('open');
    }
  });
})(Zepto);
;
...
$(function() {
  var center, infoWindow, infoWindowTemplate, map, mapOptions, rest, _i, _len, _results;
